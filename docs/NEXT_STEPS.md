...
- ✅ **G3-B — размещение зданий героем на сетке.**
  ...
  - Пока БЕЗ футпринт-коллайдеров: враги — steer-to-target без пасфайндинга, блок бы их
  ...
  - **Тестировать на host-сессии/устройстве** (визуал призрака, кнопки, постройка). Возможные
    доводки: клик-по-земле на десктопе (мышь свободна), футпринт-коллайдеры зданий (пасфайндинг
    уже есть — FlowField).
