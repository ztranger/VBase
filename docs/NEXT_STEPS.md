...
- ✅ **G5 — PvP (фундамент готов).** Две базы (team 1/2), у каждой офенсив-спавнер, чьи враги
  ...
  - Осталось (полировка): **баланс PvP** (сейчас `pvp.scene` без башен — с обороной + лимитом волн
    из конфига (`max 6`) матч стейлмейтит; нужны непрерывные волны / офенс героев); per-team
