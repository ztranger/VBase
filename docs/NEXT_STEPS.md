...
- **G5 — PvP** (две базы, наступательные спавнеры, условие победы). Фундамент есть: команды у
  зданий/героев (`team`), пул per-team. Нужно: выбор стороны при подключении, спавнеры бьют по
  ЧУЖОМУ ядру, условие победы стороны.
