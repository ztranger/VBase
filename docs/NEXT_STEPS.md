...
**Осталось по мобам:** анимация смерти (Death_A/B/C) на удалении, удар по ядру (attack-клип уже
резолвится), модель самого спавнера (пока куб), разные статы по типу моба.
