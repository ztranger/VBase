...
// Какой 3D-путь рисовать под UI: платформа берёт его отсюда (одна таблица mode->RenderPath),
// а не собирает тернар из mode() сама. Оверлеи Pause/Results путь не меняют — они поверх боя.
